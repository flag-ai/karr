...
func TestCORS_NoOrigins_NoCORSHeaders(t *testing.T) {
...
func TestCORS_MultipleOrigins(t *testing.T) {
	handler := middleware.CORS("http://localhost:5173, http://localhost:8080")(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
